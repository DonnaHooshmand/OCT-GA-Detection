...
def main():
    ...
    data_path = './GA_Detection/data/sample/'
    ...
    train_model_early_stopping(model, train_loader, val_loader, criterion, optimizer, num_epochs, best_model_path, experiment_dir,patience=2)
